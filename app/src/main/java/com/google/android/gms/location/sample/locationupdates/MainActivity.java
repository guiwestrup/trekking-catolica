...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String KEY_LOCATION = "bluetooth";
    ...
    private Location mCurrentLocation3;
    // UI Widgets.
    private Button mStartUpdatesButton;
    private Button mStopUpdatesButton;
    private Button btnStartBluetooth;
    private Button mMarcarButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Log.i("BT", "vai pegar BluetoothAdapter");
        // cria instância do adapter
        mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
        //Log.i("BT", "tentou pegar BluetoothAdapter");

        if (mBluetoothAdapter != null) {
            //Log.i("BT", "pegou BluetoothAdapter");
            // Inicia a conexao
            if (!mBluetoothAdapter.isEnabled()) {
                //Log.i("BT", "BluetoothAdapter ativo");
        ...
        btnStartBluetooth = (Button) findViewById(R.id.send_message);
        mStartUpdatesButton = (Button) findViewById(R.id.start_updates_button);
        mStopUpdatesButton = (Button) findViewById(R.id.stop_updates_button);
        mFirstText = (TextView) findViewById(R.id.fist_text);
    ...
    private void inseriLocalizacao(){
        mLocationCallback = new LocationCallback() {
            @Override
            public void onLocationResult(LocationResult locationResult) {
                super.onLocationResult(locationResult);
                //aonde seta o local
                mCurrentLocation2 = locationResult.getLastLocation();
                updateUInova();
            }
        };
    }
    private void updateUInova(){
            ...
            case REQUEST_CHECK_SETTINGS:
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        Log.i("BT", "dfkfdsn pareados");
                        if (pairedDevices.size() > 0) {
                            Log.i("BT", "tem pareados");
                            // Loop through paired devices
                            for (BluetoothDevice device : pairedDevices) {
                                // Add the name and address to an array adapter to show in a ListView
                                Log.i("BT", device.getName() + "\n" + device.getAddress());

                                mFirstText.append(device.getName() + "\n" + device.getAddress());
    ...
    public void sendMessage(View view){
        ...
        TextView messageBox = (TextView) findViewById(R.id.second_text);
    ...
    private void updateLocationUI() {
        ...
        if (mCurrentLocation != null) {
            ...
            TrekkingLocationSingleton singleton = TrekkingLocationSingleton.getInstance();
            mFirstText.setText(String.format(Locale.ENGLISH, singleton.getListOfLocationAsText()));
